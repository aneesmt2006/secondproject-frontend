...
import { Calendar, Camera, Lock, Mail, Phone } from 'lucide-react'
import Card from '../../../components/Card'
import Input from '../../../components/Input'
import Button from '../../../components/Button'
import { ThreeDot } from 'react-loading-indicators'
import { RegistrationFormProps } from '../types/register.type'
import { useNavigate } from 'react-router-dom'
import useRegistrationForm from '../hooks/useRegistrationForm'
const RegisterForm = ({ onSubmit, onGoogleSignUp,isLoad }:RegistrationFormProps) => {
    const {handleChange,handlePhotoUpload,handleSubmit,photoPreview,errors,formData} = useRegistrationForm(onSubmit)
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {!isLoad ? (
              ...
              <>
                Sending your code  <ThreeDot color="white" size="small" text="" textColor="" />
              </>
            )}
          </Button>
